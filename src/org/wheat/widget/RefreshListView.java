...
public class RefreshListView extends ListView implements OnScrollListener
{
    ...
    private final static int REFRESH_BACKEND = 1;        //达到刷新界限，反弹结束后
    ...
    void init(final Context context) {
        ...
        mFooterLinearLayout.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (context.getString(R.string.list_footer_more).equals(mFooterTextView.getText())) {
                    mFooterTextView.setText(R.string.list_footer_loading);
        ...
        mHeaderUpdateText.setText(context.getString(R.string.list_header_refresh_last_update, mSimpleDateFormat.format(new Date())));
    }
	@Override
	...
	private Handler mHandler=new Handler()
	{
		...
		public void handleMessage(Message msg)
		{
			...
			case REFRESH_DONE:
				...
				mHeaderPullDownImageView.setVisibility(View.VISIBLE);
                mHeaderReleaseDownImageView.setVisibility(View.GONE);
                mHeaderUpdateText.setText(getContext().getString(R.string.list_header_refresh_last_update, mSimpleDateFormat.format(new Date())));
                mHeaderLinearLayout.setPadding(mHeaderLinearLayout.getPaddingLeft(),
                        0,
                        mHeaderLinearLayout.getPaddingRight(),
                        mHeaderLinearLayout.getPaddingBottom());
